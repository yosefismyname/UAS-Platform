...
<?php $__env->startSection('title', 'Registrasi Admin'); ?>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form method="POST" action="<?php echo e(route('tambahadmin')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\cartogo\resources\views/tambahadmin.blade.php ENDPATH**/ ?>